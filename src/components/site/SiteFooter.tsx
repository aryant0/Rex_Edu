    ...
    <footer className="bg-primary text-primary-foreground mt-24">
      <div className="container mx-auto px-4 py-16 grid gap-10 md:grid-cols-2 lg:grid-cols-5">
        ...
        <div className="lg:col-span-2">
          <Link
            to="/"
            className="flex items-center gap-3 font-display font-bold text-xl"
          >
            <img
              src="/logo.png"
              alt="Educapital Logo"
            ...
            />
            <span>Educapital Consultancy</span>
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm opacity-80">
            ...
            <li>
              <Link to="/study-india">Admission Assistance</Link>
            </li>
            <li>
              <Link to="/mbbs-abroad">MBBS Abroad</Link>
            </li>
            <li>
              <Link to="/study-europe">Study in Europe</Link>
            </li>
            <li>
              <Link to="/study-abroad">Visa Guidance</Link>
            </li>
          </ul>
        </div>
