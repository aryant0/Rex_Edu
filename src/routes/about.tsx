...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Us — Educapital Consultancy" },
      { name: "description", content: "Educapital Consultancy Pvt Ltd — 9+ years of guiding students to top universities in India and abroad with transparency and care." },
      { property: "og:title", content: "About — Educapital Consultancy" },
      { property: "og:description", content: "Our story, mission and values — shaping student futures since 2015." },
