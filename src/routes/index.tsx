...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Educapital Consultancy — Study in India & Abroad | Admissions, MBBS, Visa" },
      { name: "description", content: "Educapital Consultancy Pvt Ltd — Expert career counseling, admissions in India & overseas, MBBS abroad, visa & scholarship guidance. 98% visa success." },
      { property: "og:title", content: "Educapital Consultancy — Shaping Futures, One Student at a Time" },
      { property: "og:description", content: "Career counseling, university admissions, MBBS abroad, study in Europe — end-to-end student support." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Educapital Consultancy Private Limited",
          email: "info@educapitalconsultancy.com",
          telephone: "+91-91425-43546",
          address: {
            "@type": "PostalAddress",
            streetAddress: "2705-W/38, Lodha Amara",
            addressLocality: "Thane",
            addressRegion: "Maharashtra",
            postalCode: "400607",
            addressCountry: "IN",
          },
          taxID: "27AAJCE6530H1ZK",
        }),
      },
    ],
  }),
...
function Gallery() {
  const images = Array.from({ length: 12 }).map((_, i) => `https://images.unsplash.com/photo-${[
    "1523050854058-8df90110c9f1","1541339907198-e08756dedf3f","1517048676732-d65bc937f952",
    "1571260899304-425eee4c7efc","1532649842669-fe0ad4b76e36","1607799279861-4dd421887fb3",
