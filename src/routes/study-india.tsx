...
export const Route = createFileRoute("/study-india")({
  head: () => ({
    meta: [
      { title: "Study in India — Top Universities | Educapital" },
      { name: "description", content: "Admission guidance for Engineering, Law, BBA/BCA, Design, Medical (NEET), MBA/PGDM across India's top universities." },
      { property: "og:title", content: "Study in India — Educapital Consultancy" },
      { property: "og:description", content: "Top Indian universities across every major stream — with state-wise lists." },
      { property: "og:url", content: "/study-india" },
    ],
    links: [{ rel: "canonical", href: "/study-india" }],
  }),
