...
export const Route = createFileRoute("/events")({
  head: () => ({
    meta: [
      { title: "Events & Education Fairs — Educapital" },
      { name: "description", content: "Join upcoming education fairs, webinars and university spot-admission events with Educapital." },
      { property: "og:title", content: "Events — Educapital" },
      { property: "og:description", content: "Education fairs, webinars and university interactions." },
