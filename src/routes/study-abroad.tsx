...
export const Route = createFileRoute("/study-abroad")({
  head: () => ({
    meta: [
      { title: "Study Abroad — UK, USA, Canada & 35+ Countries | Educapital" },
      { name: "description", content: "Expert admission and visa guidance for UK, USA, Canada, Australia, Germany, Ireland and 30+ more countries. 98% visa success." },
      { property: "og:title", content: "Study Abroad with Educapital" },
      { property: "og:description", content: "35+ countries. 150+ partner universities. End-to-end student support." },
