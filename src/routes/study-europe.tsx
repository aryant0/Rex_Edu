...
export const Route = createFileRoute("/study-europe")({
  head: () => ({
    meta: [
      { title: "Study in Europe — Free Tuition Options | Educapital" },
      { name: "description", content: "Free tuition at German public universities. 18+ European countries with post-study work visas and PR pathways." },
      { property: "og:title", content: "Study in Europe — Educapital" },
      { property: "og:description", content: "18+ countries. Free / low tuition. PSW visas. PR pathways." },
      { property: "og:url", content: "/study-europe" },
    ],
    links: [{ rel: "canonical", href: "/study-europe" }],
  }),
