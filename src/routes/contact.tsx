...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Educapital Consultancy" },
      { name: "description", content: "Book a free counseling session. Email info@educapitalconsultancy.com or WhatsApp +91 91425 43546." },
      { property: "og:title", content: "Contact Educapital Consultancy" },
      { property: "og:description", content: "Free career counseling. We respond within 24 hours." },
