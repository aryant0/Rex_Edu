...
export const Route = createFileRoute("/mbbs-abroad")({
  head: () => ({
    meta: [
      { title: "MBBS Abroad — NMC & WHO Approved Universities | Educapital" },
      { name: "description", content: "Affordable, quality MBBS abroad in Russia, Georgia, Kazakhstan, Kyrgyzstan, Uzbekistan and more — FMGE prep & visa support." },
      { property: "og:title", content: "MBBS Abroad — Educapital" },
      { property: "og:description", content: "NMC & WHO approved universities. FMGE preparation. 98% visa success." },
      { property: "og:url", content: "/mbbs-abroad" },
    ],
    links: [{ rel: "canonical", href: "/mbbs-abroad" }],
  }),
  component: MbbsPage,
});
